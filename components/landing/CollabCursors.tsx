...
const CURSORS = [
  {
    ...
    color: "#FFD600",
    textColor: "#0A0A0A",
    animName: "cursor-webhook",
    duration: "18s",
    keyframes: `@keyframes cursor-webhook {
  ...
  },
  {
    ...
    color: "#FF6B35",
    textColor: "#FFFFFF",
    animName: "cursor-gateway",
    duration: "22s",
    keyframes: `@keyframes cursor-gateway {
  ...
  },
  {
    ...
    color: "#4ADE80",
    textColor: "#0A0A0A",
    animName: "cursor-acct",
    duration: "26s",
    keyframes: `@keyframes cursor-acct {
  ...
  },
  {
    ...
    color: "#60A5FA",
    textColor: "#0A0A0A",
    animName: "cursor-trace",
    duration: "30s",
    keyframes: `@keyframes cursor-trace {
