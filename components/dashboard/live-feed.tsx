      ...
      <div className="overflow-y-auto flex-1 max-h-[420px]">
        {feed.map((tx, i) => {
          ...
          return (
            <div
              key={tx.id}
              className={`flex items-start gap-3 px-4 py-2.5 border-b border-border/40 hover:bg-secondary/20 transition-all ${isNew ? "bg-cyan-400/5" : ""}`}
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="font-mono text-sm font-semibold text-foreground whitespace-nowrap">${tx.amount.toFixed(2)}</span>
                </div>
